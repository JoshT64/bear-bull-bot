...
tickers = ["GIS", "AMZN", "IYR", "SPLV", "LUV", "CHWY", "CPNG", "TLT", "BNGO", "GLD", "SLV", "FSLY", "TSLA", "WMT", "CL", "MO", "KMB", "MSFT", ]
...
for ticker in tickers:
    ...
    bearish_divs, bullish_divs, bearish_hidden_divs, bullish_hidden_divs = find_divergences(df['Open'].values, df['RSI'].values)
